        ...
        children: [
          ...
          Expanded(
            child: GestureDetector(
              onTap: () {},
              child: Text(
                'Share something with the community…'.tr,
  ...
  void _showAboutPost() {
    Get.dialog(
      AlertDialog(
        ...
        title: Text('About this post'.tr),
        content: Text(
          'This is a healthy meal post shared by a nutritionist.'.tr,
        ),
        actions: [
          TextButton(
            onPressed: () {
  ...
  Widget _following() {
    return Center(
      child: Column(
        ...
        children: [
          const Icon(Icons.people_outline_rounded, color: green, size: 70),
          const SizedBox(height: 12),
          Text(
            'Following'.tr,
          ...
          Text(
            'Posts from people you follow'.tr,
            style: const TextStyle(color: Colors.grey),
          ),
        ],
      ),
