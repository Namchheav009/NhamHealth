...
class FoodNutritionModel {
  ...
  FoodNutritionModel copyWith({
    ...
    String? cuisine,
    String? mealType,
    bool? requiresDrinkDetails,
    double? mealIdentityConfidence,
    double? portionConfidence,
    double? preparationConfidence,
    List<DetectedFoodComponentModel>? components,
    List<FoodCandidateModel>? candidates,
    bool? nutritionComplete,
  }) {
    return FoodNutritionModel(
      id: id ?? this.id,
      ...
      databaseMatched: databaseMatched ?? this.databaseMatched,
      databaseMatchConfidence:
          databaseMatchConfidence ?? this.databaseMatchConfidence,
      ...
      requiresDrinkDetails: requiresDrinkDetails ?? this.requiresDrinkDetails,
      mealIdentityConfidence:
          mealIdentityConfidence ?? this.mealIdentityConfidence,
      portionConfidence: portionConfidence ?? this.portionConfidence,
      preparationConfidence:
          preparationConfidence ?? this.preparationConfidence,
      components: components ?? this.components,
      candidates: candidates ?? this.candidates,
      nutritionComplete: nutritionComplete ?? this.nutritionComplete,
    );
  }
