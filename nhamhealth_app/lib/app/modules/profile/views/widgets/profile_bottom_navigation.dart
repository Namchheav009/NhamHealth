...
class ProfileBottomNavigation extends GetView<ProfileController> {
                      ...
                      child: Row(
                        ...
                        children: [
                          _NavItem(
                            ...
                            onTap: () => controller.changeNavigation(0),
                          ),
                          _NavItem(
                            icon: Icons.restaurant_menu_rounded,
                            label: 'Meals',
                            selected: selectedIndex == 1,
                            onTap: () => controller.changeNavigation(1),
                          ),
                          ...
                          _NavItem(
                            ...
                            onTap: () => controller.changeNavigation(3),
                          ),
                          _NavItem(
                            ...
                            onTap: () => controller.changeNavigation(4),
                          ),
                        ],
                      ),
                    ),
            ...
            Positioned(
              ...
              child: Center(
                child: _PostButton(
                  ...
                  onTap: () => controller.changeNavigation(2),
                ),
              ),
            ),
          ],
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color:
                  selected
                      ? ProfileBottomNavigation._activeGreen
                      : Colors.transparent,
              borderRadius: BorderRadius.circular(25),
              ...
              child: Center(
                child: Icon(
                  ...
                  color:
                      selected
                          ? Colors.white
                          : ProfileBottomNavigation._inactiveGray,
                  size: 25,
                ),
              ),
            ),
