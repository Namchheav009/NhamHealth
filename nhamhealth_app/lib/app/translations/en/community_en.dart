const Map<String, String> communityEn = {
  ...
  'community.mutual_connections': 'Mutual connections',
  ...
  'community.remove_follower': 'Remove follower',
  'community.remove_follower_prompt':
      'Remove @name from your followers? They will not be notified.',
  'community.follower_removed': 'Follower removed',
  'community.follower_removed_success': '@name has been removed from your followers.',
  ...
  'community.search_grocery_hint':
      'Search or enter ingredient (e.g. Chicken)',
  'community.custom_ingredient': 'Custom ingredient',
  'community.add_custom_ingredient': 'Add custom ingredient',
  'community.use_custom_ingredient': 'Add "@name" as custom ingredient',
  'community.describe_cooking_step': 'Describe this cooking step',
  'community.add_step_to_list': 'Add step to list',
  'community.added_ingredients': 'Added ingredients',
  'community.added_steps': 'Added steps',
  'community.post_meal': 'Post meal',
  'community.tags_help': 'Help people discover your meal.',
  ...
  'community.choose_meal_category': 'Choose a category',
  ...
  'community.unfollowed_title': 'Unfollowed',
  'community.unfollowed_success': 'You have unfollowed @name.',
  ...
  'community.select_multiple': 'Select Multiple',
  'community.select_multiple_help': 'Invite several people at once.',
  'community.selected': 'Selected',
  'community.select_friend': 'Select',
  'community.selected_count': '@count selected',
  'community.add_x_friends': 'Add @count Friends',
  'community.confirm_follow_connections': 'Confirm friend invitations',
  'community.confirm_follow_connections_help':
      'No invitations have been sent yet. Send @count now?',
  'community.send_requests': 'Send Requests',
  'community.requests_sent': 'Requests sent',
  'community.requests_sent_count': '@count friend invitation(s) sent.',
  'community.some_requests_failed': 'Some requests were not sent',
  'community.requests_failed': 'Requests could not be sent',
