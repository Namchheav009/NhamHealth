const Map<String, String> wellnessEn = {
  ...
  'wellness.water_header_subtitle': 'Stay hydrated, stay healthy',
  'wellness.more_energy': 'More\nEnergy',
  'wellness.better_health': 'Better\nHealth',
  'wellness.healthier_skin': 'Healthier\nSkin',
  'wellness.better_focus': 'Better\nFocus',
  'wellness.todays_total': "Today's total",
  'wellness.water_goal_ml': 'Goal: @amount ml',
  'wellness.tip': 'Tip',
  'wellness.water_tip':
      'Try to drink water regularly throughout the day for better health and energy.',
  ...
  'wellness.amount_before_analysis_help':
      'Adjust your portion for accurate nutrition analysis.',
  'wellness.amount_to_analyze': 'Portion to analyze: @amount',
  'wellness.quick_select': 'Quick select',
  'wellness.decrease_water': 'Decrease water amount',
  'wellness.increase_water': 'Increase water amount',
  ...
  'wellness.adjust_amount_actually_ate': 'Adjust the amount you actually ate.',
  'wellness.select_cup_size_and_drink_amount':
      'Select the cup size and how much you drank.',
  'wellness.preview_estimated': 'Preview (estimated)',
  'wellness.volume_to_analyse': 'Volume to analyse',
  'wellness.portion_of_cup': '@percent% of @cup ml',
  'wellness.sugar_level': 'Sugar level',
  'wellness.sugar_percentage': '@percent% sugar',
  'wellness.custom': 'Custom',
  'wellness.enter_custom_cup_size': 'Enter custom cup size (ml)',
  'wellness.nutrition_recalculated_notice':
      'Nutrition will be recalculated based on the new amount.',
  'wellness.nutrition_recalculated_drink_notice':
      'Nutrition will be recalculated based on @volume.',
  'wellness.volume_to_analyze': 'Volume to analyze',
  'wellness.nutrition_uses_selected_amount':
      'Nutrition will be calculated using @amount.',
  ...
  'wellness.portion_small': 'Small Bowl',
  'wellness.portion_small_desc': '~150g • Snack or light',
  'wellness.portion_regular': 'Regular Plate',
  'wellness.portion_regular_desc': '~300g • Standard 1 person',
  'wellness.portion_large': 'Large Plate',
  'wellness.portion_large_desc': '~450g • Generous portion',
  'wellness.portion_xlarge': 'Extra Large',
  'wellness.portion_xlarge_desc': '~600g • Shared / Double',
  'wellness.cup_small': 'Small Cup (250ml)',
  'wellness.cup_regular': 'Regular Cup (500ml)',
  'wellness.cup_large': 'Large Cup (700ml)',
  'wellness.sugar_no': 'No Sugar (0%)',
  'wellness.sugar_less': 'Less Sugar (25%)',
  'wellness.sugar_half': 'Half Sugar (50%)',
  ...
  'wellness.plate_item_calories': 'Calories (kcal)',
  'wellness.included_in_totals': 'Included in total',
  'wellness.select_portion': 'Select Portion',
  'wellness.items_selected': '@count items selected',
  'wellness.choose_plate_size': 'Choose Plate / Portion Size',
  'wellness.choose_drink_size': 'Choose Drink Size',
  'wellness.sugar_level_cubes': 'Sugar Level (@cubes cubes)',
  'wellness.portion_quarter': 'Snack / Light',
  'wellness.portion_quarter_desc': '~75g • Light bite or snack',
  'wellness.portion_quarter_short': 'Snack',
  ...
  'wellness.preparation': 'Preparation',
  'wellness.visible_evidence': 'Why AI detected this',
  'wellness.database_verified': 'Database verified',
  'wellness.ai_nutrition_estimate': 'AI nutrition estimate',
  'wellness.needs_review': 'Needs review',
