...
public class PlannerMeal {
    ...
    @Column(name = "planner_meal_id") private Integer plannerMealId;
    @Column(name = "legacy_meal_id") private Integer legacyMealId;
    @Column(name = "name_en", nullable = false, length = 150) private String nameEn;
    @Column(name = "name_km", length = 150) private String nameKm;
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "category_id", nullable = false)
    private MealCategory category;
    @Column(name = "category_en", nullable = false, length = 80) private String categoryEn;
    @Column(name = "category_km", length = 80) private String categoryKm;
    @Column(name = "description_en", columnDefinition = "text") private String descriptionEn;
    @Column(name = "description_km", columnDefinition = "text") private String descriptionKm;
    @Column(name = "image_url", length = 500) private String imageUrl;
    @Column(name = "calories", nullable = false) private BigDecimal calories = BigDecimal.ZERO;
    @Column(name = "protein_grams", nullable = false) private BigDecimal proteinGrams = BigDecimal.ZERO;
    @Column(name = "carbs_grams", nullable = false) private BigDecimal carbsGrams = BigDecimal.ZERO;
    ...
    public Integer getPlannerMealId() { return plannerMealId; }
    public void setPlannerMealId(Integer v) { plannerMealId = v; }
    public Integer getLegacyMealId() { return legacyMealId; }
    public String getNameEn() { return nameEn; }
    public void setNameEn(String v) { nameEn = v; }
    public String getNameKm() { return nameKm; }
    public void setNameKm(String v) { nameKm = v; }
    public String getCategoryEn() { return categoryEn; }
    public void setCategoryEn(String v) { categoryEn = v; }
    public String getCategoryKm() { return categoryKm; }
    public void setCategoryKm(String v) { categoryKm = v; }
    public MealCategory getCategory() { return category; }
    public void setCategory(MealCategory v) { category = v; }
    public String getDescriptionEn() { return descriptionEn; }
    public void setDescriptionEn(String v) { descriptionEn = v; }
    public String getDescriptionKm() { return descriptionKm; }
    public void setDescriptionKm(String v) { descriptionKm = v; }
    ...
    public void setProteinGrams(BigDecimal v) { proteinGrams = v; }
    public BigDecimal getCarbsGrams() { return carbsGrams; }
    public void setCarbsGrams(BigDecimal v) { carbsGrams = v; }
    public BigDecimal getFatGrams() { return fatGrams; }
    public void setFatGrams(BigDecimal v) { fatGrams = v; }
