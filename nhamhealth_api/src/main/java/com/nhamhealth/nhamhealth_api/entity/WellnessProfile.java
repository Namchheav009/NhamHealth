...
public class WellnessProfile {
    ...
    @Column(name = "age_cached")
    private Short ageCached;
    ...
    public Integer getWellnessProfileId() {
    ...
    public Short getAgeCached() {
        return ageCached;
    }

    public void setAgeCached(Short ageCached) {
        this.ageCached = ageCached;
    }
