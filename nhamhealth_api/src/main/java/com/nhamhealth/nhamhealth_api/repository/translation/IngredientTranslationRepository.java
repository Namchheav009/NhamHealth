...
public interface IngredientTranslationRepository extends JpaRepository<IngredientTranslation,Integer>{
    List<IngredientTranslation> findByIngredientIngredientIdInAndLanguageCode(Collection<Integer> ids,String lang);
    Optional<IngredientTranslation> findByIngredientIngredientIdAndLanguageCode(Integer id,String lang);
